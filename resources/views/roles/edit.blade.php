                                                               ...
                                                               <table class="table table-striped">
                                                                      ...
                                                                      <tbody>
                                                                             ...
                                                                             <tr>
                                                                                    ...
                                                                                    <td>
                                                                                           <input type="checkbox"
                                                                                                  id="approve-user-list"
                                                                                                  value="approve.user.list"
                                                                                                  name="approve_users[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('approve.user.list', $permissions) ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ? 'disabled' : ''}}>
                                                                                           <label class="control-label2"
                                                                             ...
                                                                             <tr>
                                                                                    ...
                                                                                    <td>
                                                                                           <input type="checkbox"
                                                                                                  id="pending-user-list"
                                                                                                  value="pending.user.list"
                                                                                                  name="pending_users[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('pending.user.list', $permissions) ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ? 'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                             ...
                                                                             <tr>
                                                                                    ...
                                                                                    <td>
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="reports[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('transaction.report', $permissions) ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ? 'disabled' : ''}}>
                                                                                           <label class="control-label2"
                                                                             ...
                                                                             <tr>
                                                                                    ...
                                                                                    <td>
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="vehicle-type[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('vehicle.type.list', $permissions) ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ? 'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="vehicle-type[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('vehicle.type.create', $permissions) ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ? 'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="vehicle-type[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('vehicle.type.edit', $permissions) ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ? 'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                             ...
                                                                             <tr>
                                                                                    ...
                                                                                    <td>
                                                                                           <input type="checkbox"
                                                                                                  id="vehicle-brand-list"
                                                                                                  value="vehicle.brand.list"
                                                                                                  name="vehicle-brand[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('vehicle.brand.list', $permissions) ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ? 'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                                  for="vehicle-brand-list">{{trans('lang.list')}}</label>

                                                                                           <input type="checkbox"
                                                                                                  id="vehicle-brand-create"
                                                                                                  value="vehicle.brand.create"
                                                                                                  name="vehicle-brand[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('vehicle.brand.create', $permissions) ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ? 'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                                  for="vehicle-brand-create">{{trans('lang.create')}}</label>

                                                                                           <input type="checkbox"
                                                                                                  id="vehicle-brand-edit"
                                                                                                  value="vehicle.brand.edit"
                                                                                                  name="vehicle-brand[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('vehicle.brand.edit', $permissions) ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ? 'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                                  for="vehicle-brand-edit">{{trans('lang.edit')}}</label>

                                                                                           <input type="checkbox"
                                                                                                  id="vehicle-brand-delete"
                                                                                                  value="vehicle.brand.delete"
                                                                                                  name="vehicle-brand[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('vehicle.brand.delete', $permissions) ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ? 'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                             ...
                                                                             <tr>
                                                                                    ...
                                                                                    <td>
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  value="vehicle.model.list"
                                                                                                  name="vehicle-model[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('vehicle.model.list', $permissions) ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ? 'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                                  for="vehicle-model-list">{{trans('lang.list')}}</label>

                                                                                           <input type="checkbox"
                                                                                                  id="vehicle-model-create"
                                                                                                  value="vehicle.model.create"
                                                                                                  name="vehicle-model[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('vehicle.model.create', $permissions) ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ? 'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                                  for="vehicle-model-create">{{trans('lang.create')}}</label>

                                                                                           <input type="checkbox"
                                                                                                  id="vehicle-model-edit"
                                                                                                  value="vehicle.model.edit"
                                                                                                  name="vehicle-model[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('vehicle.model.edit', $permissions) ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ? 'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                                  for="vehicle-model-edit">{{trans('lang.edit')}}</label>

                                                                                           <input type="checkbox"
                                                                                                  id="vehicle-model-delete"
                                                                                                  value="vehicle.model.delete"
                                                                                                  name="vehicle-model[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('vehicle.model.delete', $permissions) ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ? 'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                             ...
                                                                             <tr>
                                                                                    ...
                                                                                    <td>
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="ride_order[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('order.delete', $permissions) ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ? 'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  id="user-ride-detail"
                                                                                                  value="user.ride.detail"
                                                                                                  name="user-ride-detail[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('user.ride.detail', $permissions) ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ? 'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                             ...
                                                                             <tr>
                                                                                    ...
                                                                                    <td>
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="cms[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('cms.list', $permissions) ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ? 'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                             ...
                                                                             <tr>
                                                                                    ...
                                                                                    <td>
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="faq[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('faq.list', $permissions) ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ? 'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="faq[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('faq.create', $permissions) ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ? 'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="faq[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('faq.edit', $permissions) ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ? 'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                             ...
                                                                             <tr>
                                                                                    ...
                                                                                    <td>
                                                                                           <input type="checkbox"
                                                                                                  id="complaints-list"
                                                                                                  value="complaints.list"
                                                                                                  name="complaints[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('complaints.list', $permissions) ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ? 'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                             ...
                                                                             <tr>
                                                                                    ...
                                                                                    <td>
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="tax[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('tax.list', $permissions) ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ? 'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                             ...
                                                                             <tr>
                                                                                    ...
                                                                                    <td>
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="currency[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('currency.list', $permissions) ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ? 'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="currency[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('currency.create', $permissions) ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ? 'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="currency[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('currency.edit', $permissions) ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ? 'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                             ...
                                                                             <tr>
                                                                                    ...
                                                                                    <td>
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="language[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('language.list', $permissions) ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ? 'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="language[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('language.create', $permissions) ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ? 'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="language[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('language.edit', $permissions) ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ? 'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                             ...
                                                                             <tr>
                                                                                    ...
                                                                                    <td>
                                                                                           <input type="checkbox"
                                                                                                  id="complaint-subject-list"
                                                                                                  value="complaint.subject.list"
                                                                                                  name="complaint-subject[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('complaint.subject.list', $permissions) ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ? 'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                                  for="complaint-subject-list">{{trans('lang.list')}}</label>

                                                                                           <input type="checkbox"
                                                                                                  id="complaint-subject-create"
                                                                                                  value="complaint.subject.create"
                                                                                                  name="complaint-subject[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('complaint.subject.create', $permissions) ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ? 'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                                  for="complaint-subject-create">{{trans('lang.create')}}</label>
                                                                                           <input type="checkbox"
                                                                                                  id="complaint-subject-edit"
                                                                                                  value="complaint.subject.edit"
                                                                                                  name="complaint-subject[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('complaint.subject.edit', $permissions) ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ? 'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                                  for="complaint-subject-edit">{{trans('lang.edit')}}</label>
                                                                                           <input type="checkbox"
                                                                                                  id="complaint-subject-delete"
                                                                                                  value="complaint.subject.delete"
                                                                                                  name="complaint-subject[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('complaint.subject.delete', $permissions) ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ? 'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                             ...
                                                                             <tr>
                                                                                    ...
                                                                                    <td>
                                                                                           <input type="checkbox"
                                                                                                  id="dynamic-notification-list"
                                                                                                  value="dynamic.notification.list"
                                                                                                  name="dynamic-notification[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('dynamic.notification.list', $permissions) ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ? 'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                                  for="dynamic-notification-list">{{trans('lang.list')}}</label>

                                                                                           <input type="checkbox"
                                                                                                  id="dynamic-notification-edit"
                                                                                                  value="dynamic.notification.edit"
                                                                                                  name="dynamic-notification[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('dynamic.notification.edit', $permissions) ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ? 'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                             ...
                                                                             <tr>
                                                                                    ...
                                                                                    <td>
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="email-template[]"
                                                                                                  class="permission"  {{in_array('email.template.index', $permissions) ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ? 'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="email-template[]"
                                                                                                  class="permission" {{in_array('email.template.save', $permissions) ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ? 'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                             ...
                                                                             <tr>
                                                                                    ...
                                                                                    <td>
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="payout-request[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('payout-request', $permissions) ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ? 'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                             ...
                                                                             <tr>
                                                                                    ...
                                                                                    <td>
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  class="permission"
                                                                                                  {{in_array('user.wallet.list', $permissions) ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ? 'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                             ...
                                                                             <tr>
                                                                                    ...
                                                                                    <td>
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="global-setting[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('global-setting', $permissions) ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ? 'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                             ...
                                                                             <tr>
                                                                                    ...
                                                                                    <td>
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  class="permission"
                                                                                                  {{in_array('notification-setting', $permissions) ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ? 'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                             ...
                                                                             <tr>
                                                                                    ...
                                                                                    <td>
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  class="permission"
                                                                                                  {{in_array('home-page', $permissions) ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ? 'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                             ...
                                                                             <tr>
                                                                                    ...
                                                                                    <td>
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="privacy[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('privacy', $permissions) ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ? 'disabled' : ''}}>
                                                                                           <label class=" control-label2"
