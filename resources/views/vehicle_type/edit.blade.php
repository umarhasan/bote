                ...
                <div class="row restaurant_payout_create">
                    <div class="restaurant_payout_create-inner">
                        <fieldset>
                            ...
                            <div class="form-group row width-100">
                                <label class="col-4 control-label global_value_label">{{trans('lang.per_km_charges')}}</label>
                                <div class="col-7">
                                    <input name="per_km_charges" id="per_km_charges"
                                        class="form-control per_km_charges">
                                    <div class="global_value_text"></div> 
                                </div>
                            </div>
                            <div class="form-group row width-100">
...
<script>
    ...
    $(document).ready(function () {
        ...
        ref.get().then(async function (snapshots) {
            ...
            if (data.hasOwnProperty('perKmCharges')) {
                $('#per_km_charges').val(data.perKmCharges);
            }
            if (data.enable) {
    ...
    $(".edit_vehicle_btn").click(function () {
        ...
        var per_km_charge = $("#per_km_charges").val();
        var enable = false;
        ...
        if (name == '') {
            ...
            window.scrollTo(0, 0);
        } else if (per_km_charge == '') {
            $(".error_top").show();
            $(".error_top").html("");
            $(".error_top").append("<p>"+$('.global_value_text').html()+"</p>");
            window.scrollTo(0, 0);
        } else {
            jQuery("#overlay").show();
