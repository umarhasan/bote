...
<script type="text/javascript">
    ...
    async function getListData(val) {
        ...
        if (symbolAtRight) {
            html = html + '<td>' + parseFloat(val.perKmCharges).toFixed(decimal_degits) +currentCurrency+'</td>';
        } else {
            html = html + '<td>'+ currentCurrency+ parseFloat(val.perKmCharges).toFixed(decimal_degits) + '</td>';
        }
