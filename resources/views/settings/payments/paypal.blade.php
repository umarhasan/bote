...
<div class="page-wrapper">
    <div class="card">
        ...
        <div class="form-group col-12 text-center btm-btn">
            <button type="button" class="btn btn-primary save_paypal_btn"><i class="fa fa-save"></i>
...
<script>
    ...
    $(document).ready(function () {
        ...
        paymentRef.get().then(async function (paymentSnapshots) {
            ...
            $('.paypal_app_id').val(payment.paypalClient);
        ...
        $(".save_paypal_btn").click(function () {
            ...
            database.collection('settings').doc("payment").update({
                ...
                'paypal.paypalClient': paypal_app_id,
                'paypal.paypalSecret': paypal_secret,
                'paypal.isWithdrawEnabled': isWithdrawEnabled
