...
<body>
    ...
    <style type="text/css">
        ...
        .form-material .form-control:focus {
            background-image: linear-gradient(<?php    echo $_COOKIE['admin_panel_color']; ?>,
                    <?php    echo $_COOKIE['admin_panel_color']; ?>
    ...
    <section id="wrapper">
        ...
        <div class="login-register">
            ...
            <div class="login-logo text-center py-3">
                ...
                <a href="#"><img src="{{ asset('images/logo-poolmate.png') }}" class="dark-logo"> </a>
    ...
    <script type="text/javascript">
        ...
        globalLogoRef.get().then(async function (snapshots) {
            ...
            appLogo = (globalLogoSetting.appLogo) ? globalLogoSetting.appLogo : "{{ asset('images/logo-poolmate.png') }}";
        ...
        globalRef.get().then(async function (snapshots) {
            ...
            if (globalSetting.adminColor != '') {
                setCookie('admin_panel_color', globalSetting.adminColor, 365);
                $('.login-register').css({ 'background-color': globalSetting.adminColor });
            }
